...
import StationFinderModal from './StationFinderModal';
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg border border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-2 border-energy-primary bg-white text-energy-primary hover:bg-energy-primary hover:text-white px-8 py-4 rounded-full"
